...
class TodayCell: BaseTodayCell {
    ...
    let descriptionLabel = UILabel(text: "All the tools and apps you need to intelligently organzie your life the right way.", font: .systemFont(ofSize: 16), numberOfLines: 3)
